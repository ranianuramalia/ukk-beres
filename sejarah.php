            ...
            <div class="container bg-light-subtle rounded-5 p-5 shadow p-3 mb-5 bg-body-tertiary rounded mt-4 pt-5">
                <div class="row">
                    <div class="col d-flex justify-content-center">
                        <div class="card my-3">
                            <img src="./image/poto3.png" class="img-fluid rounded-3" alt="" width="600" height="600">
                        </div>
                    </div>
                </div>
                <div class="row pt-5">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <p>Setelah melalui perjuangan yang sangat panjang dari berbagai pihak khususnya Disdik Kota
                            ...
                            induknya adalah SMK Negeri 2 Kota Tasikmalaya, Untuk Tenaga pendidik dan Tenaga Kependidikan
                            masih dibantu sepenuhnya oleh kedua sekolah tersebut.</p>
                        <p>Pada tahun 2012 keluarlah surat Izin Pendirian berdasarkan keputusan kepala Badan Pelayanan
